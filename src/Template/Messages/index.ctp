    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $message->has('sender') ? $this->Html->link($message->sender->name, ['controller' => 'Users', 'action' => 'view', $message->sender->id]) : '' ?></td>
                <td><?= $message->has('receiver') ? $this->Html->link($message->receiver->name, ['controller' => 'Users', 'action' => 'view', $message->receiver->id]) : '' ?></td>
